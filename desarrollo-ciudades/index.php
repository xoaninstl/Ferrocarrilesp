...
<head>
    ...
    <title>Desarrollo Ciudades - Blog Ferrocarriles</title>
...
<body>
    ...
    <main class="main-content">
        <div class="container">
            <div class="category-header">
                <h2>🏙️ Desarrollo Ciudades</h2>
                <p>Descubre cómo el ferrocarril ha transformado el desarrollo urbano en España</p>
            </div>
            ...
            <div class="additional-filters">
                ...
                <div class="filter-options">
                    ...
                    <label><input type="checkbox" value="proyectos_en_marcha" onchange="filterByAdditionalCategory()"> Proyectos en Marcha</label>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Cargar contenido de la categoría "desarrollo_ciudades"
            loadCategoryContent('desarrollo_ciudades');
        });
    </script>
</body>
</html>
