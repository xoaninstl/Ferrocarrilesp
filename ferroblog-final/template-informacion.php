<?php
/**
 * Template Name: Plantilla de Información
 *
 * Esta es la plantilla para mostrar una página con un diseño específico para información técnica.
 * Basada en la plantilla-informacion.html original.
 */
...
<div class="content-left">
    ...
    <div class="breadcrumb">
        ...
        <a href="<?php echo esc_url(get_permalink()); ?>">Información</a> > 
        ...
        <article class="informacion-article">
            ...
            <header class="article-header">
                ...
                <div class="article-meta">
                    <span class="article-date">📅 Actualizado el <?php echo get_the_modified_date('j \d\e F \d\e Y'); ?></span>
