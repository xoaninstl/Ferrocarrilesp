<?php get_header(); ?>
    <div class="content-left">
        <section class="section">
            <h2><?php single_cat_title('Categoría: '); ?></h2>
            <?php if (category_description()) : ?>
                <p class="section-intro"><?php echo category_description(); ?></p>
            <?php endif; ?>
        </section>
        <div class="latest-posts">
            ...
            <?php endwhile; else: ?>
                <div class="no-content"><h3>No hay contenido en esta categoría por ahora.</h3></div>
            <?php endif; ?>
