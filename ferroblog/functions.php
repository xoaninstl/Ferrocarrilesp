...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('ferroblog-base', get_stylesheet_directory_uri() . '/assets/css/base.css', [], '1.0');
    wp_enqueue_script('ferroblog-script', get_stylesheet_directory_uri() . '/assets/js/script.js', [], '1.0', true);
});
